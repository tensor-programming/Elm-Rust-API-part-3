...
var _user$project$Main$bookEncoder = function (model) {
...
var _user$project$Main$addBook = function (model) {
	var body = _elm_lang$http$Http$jsonBody(
		_user$project$Main$bookEncoder(model));
	var url = 'http://localhost:8000/api/v1/books';
	return A3(_elm_lang$http$Http$post, url, body, _user$project$Main$statusDecoder);
};
var _user$project$Main$httpBookCompleted = F2(
...
var _user$project$Main$Book = F4(
	function (a, b, c, d) {
		return {title: a, author: b, published: c, id: d};
	});
var _user$project$Main$bookDecoder = A5(
...
var _user$project$Main$isChecked = function (bool) {
	return bool ? _user$project$Main$GetPublished : _user$project$Main$NoOp;
};
var _user$project$Main$GetAuthor = function (a) {
	return {ctor: 'GetAuthor', _0: a};
};
var _user$project$Main$GetTitle = function (a) {
	return {ctor: 'GetTitle', _0: a};
};
var _user$project$Main$DelBook = function (a) {
								...
								_0: A2(
									_rundis$elm_bootstrap$Bootstrap_Button$button,
									{
										...
										_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(
											_user$project$Main$DelBook(book.id)),
										_1: {
											ctor: '::',
...
var _user$project$Main$bookForm = function (model) {
	return A2(
...
var _user$project$Main$cardView = function (model) {
		...
		A3(
			...
			{ctor: '[]'},
			{
				...
				_0: _rundis$elm_bootstrap$Bootstrap_Card$custom(
					_user$project$Main$bookForm(model)),
				_1: {
					ctor: '::',
					_0: _rundis$elm_bootstrap$Bootstrap_Card$custom(
						A2(
...
var _user$project$Main$delete = function (i) {
...
var _user$project$Main$SetBook = function (a) {
	return {ctor: 'SetBook', _0: a};
};
var _user$project$Main$bookPostCmd = function (model) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Main$SetBook,
		_user$project$Main$addBook(model));
};
